...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <AdminPage><PageBackButton /><PageHeader eyebrow="Sessions" title={s.title} description={`${s.cohort.programme.name} · ${s.cohort.teacher.name}`} /><SessionDetails session={s} admin /></AdminPage>;
}
