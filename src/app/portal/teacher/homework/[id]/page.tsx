...
import { HomeworkDetails } from "@/modules/homework";
export const metadata: Metadata = {
  title: "Homework Details | Teacher Portal",
};
  ...
  return (
    <AdminPage>
      ...
      <PageHeader
        eyebrow="Homework"
        title={h.title}
        description={`${h.session.lesson.student.name} · ${h.session.title}`}
      />
      <HomeworkDetails homework={h} />
    </AdminPage>
  );
}
