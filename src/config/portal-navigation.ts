...
import { BookOpen, CalendarDays, GraduationCap, Home, Layers3, MessageSquare, Settings, UserRound, Users } from "lucide-react";
...
{label:"Settings",href:"/portal/profile",icon:Settings,enabled:true}],
parent:[{label:"Dashboard",href:"/portal/parent",icon:Home,enabled:true},{label:"Messages",href:"/portal/parent/messages",icon:MessageSquare,enabled:false},{label:"Settings",href:"/portal/profile",icon:Settings,enabled:true}]};
