...
export function TeacherProgrammes({
  ...
  return (
    <SectionCard
      ...
      description={
        adminView
          ? "Programmes this teacher is currently authorised to teach."
    ...
    >
      {query.isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {query.data.assignments.map((assignment) => (
            <Link
              ...
              href={
                adminView
                  ? `/portal/admin/programmes/${assignment.programmeId}`
                  : "#"
              }
        ...
        <EmptyState
          ...
          description="An administrator has not assigned any programmes yet."
        />
      )}
    </SectionCard>
  );
