...
export function StudentDetails({student}:{student:StudentDetail}){
 ...
 return <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]"><div className="space-y-6">
  ...
  <div className="grid gap-5 md:grid-cols-3"><InfoCard icon={UserRound} title="Parents" description="Guardian links will appear after the Parent module is introduced."/><InfoCard icon={School} title="Class" description="Class assignment will appear after the Classes and Enrollment modules."/><InfoCard icon={FileText} title="Documents" description="Student document management will be added in a later checkpoint."/></div>
