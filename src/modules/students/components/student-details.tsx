    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
      <div className="space-y-6">
        <SectionCard contentClassName="p-6 sm:p-8">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex items-center gap-4">
              <div className="relative size-20 overflow-hidden rounded-[1.5rem] bg-primary/10">
                {student.photoUrl ? (
                  <Image
                  ...
                  <span className="grid size-full place-items-center font-display text-xl font-extrabold text-primary">
                    {student.firstName[0]}
                    {student.lastName[0]}
                  </span>
                )}
        ...
        <SectionCard
          ...
          description="Identity and basic learner details."
          contentClassName="p-5 sm:p-6"
        >
          <dl className="grid gap-5 sm:grid-cols-2">
            <Detail icon={Baby} label="Full name" value={name(student)} />
            <Detail
              icon={CalendarDays}
              label="Date of birth"
        ...
        <SectionCard title="Administrative notes" contentClassName="p-5 sm:p-6">
                ...
                {parents.map((parent) => (
                  ...
                  >
                    ...
                    <p className="text-xs capitalize text-slate-500">
                      {parent.relationship.replaceAll("_", " ")}
                      {parent.isPrimaryContact ? " · Primary contact" : ""}
                    </p>
                  </Link>
                ))}
              </div>
