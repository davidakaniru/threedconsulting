...
export interface ClassSession {
  id:string; lessonAssignmentId:string; title:string; description:string|null; sessionDate:string; startTime:string; endTime:string; meetingLink:string; status:ClassSessionStatus; createdBy:string; createdAt:string; updatedAt:string;
  lessonAssignment:{id:string;student:{id:string;name:string};programme:{id:string;name:string};teacher:{id:string;name:string}};
  attendance:AttendanceSummary; homework:HomeworkSummary;
}
