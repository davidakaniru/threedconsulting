...
6. Teacher sessions belong to the lesson assignment. Attendance and optional coursework (currently out of scope) therefore target the assigned child directly.
7. Parents see active lesson details, upcoming sessions, attendance, and optional coursework (currently out of scope) through the child switcher.
